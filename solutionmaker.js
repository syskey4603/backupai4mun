...
async function test() {
  ...
  const prompt = "imagine your the delegate of " + country.value + " in a MUN now you need to build comprehensive solutions on the agenda of " + agenda.value + " that the country can impliment, make each solution detailed and specific and each 500 words";
